...
// to reduce computations when running functions DY and DDY.
...
func (linearPolynom *LinearPolynom) GetOptimizationParamsLength() uint {
	return (linearPolynom.polynomDegree + 1) * 2
}

func (linearPolynom *LinearPolynom) GetPoints() []Point {
	return linearPolynom.points
}
